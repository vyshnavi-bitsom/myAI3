...
export const WELCOME_MESSAGE = Hello! I'm ${AI_NAME}, a minimal well-being companion created by ${OWNER_NAME}. I can help with short, 1–2 minute grounding practices and gentle check-ins when you're stressed or overwhelmed.
